import React, { createContext, useContext, useState, useEffect, useMemo, memo, useRef, useCallback, Fragment } from 'react';
import PropTypes from 'prop-types';
import * as d3Geo from 'd3-geo';
import { geoGraticule, geoPath as geoPath$1 } from 'd3-geo';
...
var MapProvider = function MapProvider(_ref2) {
  ...
  return React.createElement(MapContext.Provider, _extends({
    value: value
  }, restProps));
};
...
function useZoomPan(_ref) {
  ...
  useEffect(function () {
    ...
    function handleZoomStart() {
      ...
      onMoveStart({
        coordinates: projection.invert(getCoords(width, height, event.transform)),
...
var Sphere = function Sphere(_ref) {
  ...
  return React.createElement(Fragment, null, React.createElement("defs", null, React.createElement("clipPath", {
    id: id
...
var Annotation = function Annotation(_ref) {
  ...
  }, restProps), React.createElement("path", _extends({
    d: connectorPath,
    fill: "transparent",
    stroke: "#000"
